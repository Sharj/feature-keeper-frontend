...
export default function SettingsPage() {
  ...
  return (
    <div className="animate-fade-in space-y-10">
      ...
      {/* General Section */}
      <section>
        <h2 className="font-serif text-lg text-ink mb-4">General</h2>
              <Card padding="lg">
      ...
      {/* Ideas Section */}
      <section>
        <h2 className="font-serif text-lg text-ink mb-4">Ideas</h2>
      ...
      {/* Updates Section */}
      <section>
        <h2 className="font-serif text-lg text-ink mb-4">Updates</h2>
      ...
      {/* Plan Section */}
      <section>
        <h2 className="font-serif text-lg text-ink mb-4">Plan</h2>
              <Card padding="lg">
      ...
      {/* Danger Zone */}
      <section>
        <h2 className="font-serif text-lg text-critical mb-4">Danger Zone</h2>
