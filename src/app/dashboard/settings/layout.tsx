...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader title="Settings" backHref="/dashboard" backLabel="Back to Ideas" />

      <div className="flex gap-8 mt-6">
        <nav className="w-[200px] shrink-0 bg-surface border border-edge rounded-xl p-2 self-start sticky top-20">
